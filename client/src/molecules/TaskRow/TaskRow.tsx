...
export default function TaskRow({ task }: { task: Task }) {
    ...
    return (
        <div className="p-6 shadow-md my-6 border border-slate-200 dark:border-slate-600 rounded-lg cursor-pointer hover:bg-base-200 ease-in bg-base-100 dark:bg-base-200 justify-center grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4">
